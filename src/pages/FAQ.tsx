  ...
  const faqs = [
    {
      ...
      answer: 'You can track your order by visiting the Track Order page and entering your order number and email address. You\'ll receive real-time updates on your shipment\'s status.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We offer a 30-day return policy for most items. Products must be unused and in their original packaging. Please visit our Returns & Refunds page for detailed information.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Our customer support team is available 24/7. You can reach us through email at support@matrixcommerce.com, phone at 1-800-MATRIX, or use our live chat feature.'
    },
    {
      question: 'Do you offer warranties on products?',
      answer: 'Most products come with a manufacturer\'s warranty. The warranty period varies by product and brand. Extended warranty options are available for select items.'
    },
    {
      question: 'Can I modify or cancel my order?',
      answer: 'Orders can be modified or cancelled within 1 hour of placement. After this window, please contact customer support for assistance.'
    }
  ];
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <summary className="flex items-center justify-between cursor-pointer p-6">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white pr-6">
                  {faq.question}
                </h3>
