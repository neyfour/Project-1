...
import { PlusCircle, BarChart3, TrendingUp, DollarSign, Package, Users, ArrowUpRight, ArrowDownRight, Filter, Download } from 'lucide-react';
import { useStore } from '../store';
import { Product, SalesPrediction } from '../types';
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Track your product performance and market insights
            </p>
          </div>
        ...
        {performanceMetrics.map((metric, index) => (
          <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            <div className="flex items-start justify-between">
              ...
              <div className={`p-2 rounded-lg ${metric.isPositive ? 'bg-green-100 dark:bg-green-900/20' : 'bg-red-100 dark:bg-red-900/20'}`}>
                <metric.icon className={`w-6 h-6 ${metric.isPositive ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`} />
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Manage and monitor your product portfolio
            </p>
          </div>
          <div className="flex items-center gap-4">
