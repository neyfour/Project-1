                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white flex items-center">
                          {topic.is_pinned && (
                            <span className="inline-block w-4 h-4 bg-indigo-600 rounded-full mr-2" title="Pinned Topic"></span>
                          )}
                          {topic.title}
                          {topic.is_solved && (
            ...
            <form onSubmit={handleNewTopicSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  {categories.filter(cat => cat.id !== 'all' && cat.id !== 'announcements').map((category) => (
                    <option key={category.id} value={category.id}>
                      {category.name}
                    </option>
                  ))}
