...
conf = ConnectionConfig(
    MAIL_USERNAME=os.getenv("MAIL_USERNAME", " e.sportscompany.contact@gmail.com"),
    MAIL_PASSWORD=os.getenv("MAIL_PASSWORD", "mefr yerw tjja qkgi"),
    MAIL_FROM=os.getenv("MAIL_FROM", "e.sportscompany.contact@gmail.com"),
